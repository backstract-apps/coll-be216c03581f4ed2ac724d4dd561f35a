...
app = FastAPI(title='Backstract Generated APIs - coll-be216c03581f4ed2ac724d4dd561f35a', debug=False,
              docs_url='/focused-shalini-0b7576a4582411f0b7132a3957a8b30134/docs',
              openapi_url='/focused-shalini-0b7576a4582411f0b7132a3957a8b30134/openapi.json')
...
app.include_router(
    router,
    prefix='/focused-shalini-0b7576a4582411f0b7132a3957a8b30134/api',
    tags=['APIs v1']
)
